...
namespace my_clinic_api.Migrations
{
    ...
    [Migration("20221210204344_M2M_relation")]
    partial class M2M_relation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("my_clinic_api.Models.M2M.Doctor_Specialist", b =>
                {
                    ...
                    b.HasKey("SpecialistId", "DoctorId");

                    b.HasIndex("DoctorId");

                    b.ToTable("Doctor_Specialist");
                });
            ...
            modelBuilder.Entity("my_clinic_api.Models.M2M.Doctor_Specialist", b =>
                {
                    b.HasOne("my_clinic_api.Models.Doctor", "doctor")
                        .WithMany("DoctorSpecialist")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("my_clinic_api.Models.Specialist", "Specialist")
                        .WithMany("DoctorSpecialist")
